...
function FlightCard({ flight: f, color }) {
  ...
  return (
    <div style={{ background: isPending ? c.pendingBg : c.cardBg, borderRadius: 18, padding: '16px', marginBottom: 12, border: isPending ? `1.5px dashed #f59e0b` : `1px solid ${c.border}`, boxShadow: '0 1px 6px rgba(0,0,0,0.04)' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontSize: 12, color: c.muted, fontWeight: 500 }}>{f.airline}</span>
        </div>
